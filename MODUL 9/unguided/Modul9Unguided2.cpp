...
//Modifikasi guided tree diatas dengan program menu menggunakan input data tree dari user dan berikan fungsi 
//tambahan untuk menampilkan node child dan descendant dari node yang diinput kan!
...
void deleteSub(Pohon *node) {
    ...
    cout << "\nBuat tree terlebih dahulu!" << endl;
        ...
        deleteTree(node->left);
        deleteTree(node->right);
        cout << "\nNode subtree " << node->data << " berhasildihapus." << endl;
    }
}
